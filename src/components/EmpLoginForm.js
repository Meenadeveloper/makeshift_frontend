    ...
    const [formData, setFormData] = useState({
      ...
      const handleSubmit = (e) => {
        ...
        if (validateForm()) {
          ...
          navigate('/employee-home'); // Change to your service upload route
        }
      };
    ...
    <>
      ...
      <div className="login-card">
        ...
        <div className="login-card-image">
          <h2>Welcome Back ,<br/>Employee Login</h2>
          <img src={Login_img} alt="Placeholder" />
        </div>

        {/* Right Side Form */}
        <div className="login-card-content">
          <h2>Employee <span style={{color:'rgba(112, 89, 222, 1)'}}>Login</span></h2>
          <form onSubmit={handleSubmit} className='login-form'>
            ...
            <div className='field-button-container'>
              <button type="submit" className='login-btn' style={{margin:'30px 10px'}}>Sign up</button>
            </div>
          </form>

           <p className='sign-link'>
            Don't have an account? <Link to="/employee-register" className='forget-link'>Sign Up</Link>
          </p>

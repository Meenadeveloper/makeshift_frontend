     ...
     <div className='slot-grid-card-box'>
                            <div className='slot-card-item'>
                                 ...
                                 <div className='slot-card-body'>
                                      ...
                                      <div className='space-text'>
                                        <p className='slot-detail'>Work Started Time  :</p>
                                        <span className='slot-data'>07 : 00 am</span>
                                      </div>

                                      <div className='space-text'>
                                        <p className='slot-detail'>Work End Time  :</p>
                                        <span className='slot-data'>06 : 00 pm</span>
                                      </div>
                                 </div>
                
                                 {/* <div className='slot-card-footer'>
                                   <div className='slot-amount'><p>Sub- Total Amount</p>
                                   <button className='user-complete-btn'>Completed</button>

       ...
       <div className='slot-grid-card-box'>
                            <div className='slot-card-item'>
                                 ...
                                 <div className='slot-card-footer'>
                                   ...
                                   <button className='user-cancel-btn user-non-refund-btn'>Amount Not Refund</button>
                            ...
                            <div className='slot-card-item'>
                                 ...
                                 <div className='slot-card-footer'>
                                   ...
                                   <div>
                                   <p className='amount-number'>&#8377; 3,000</p>
                                   <button className='user-cancel-btn refund-btn '>Amount  Refund</button>
...
export default CancelCardNotRefund

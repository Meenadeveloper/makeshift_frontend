...
import { toggleEmpSidebar } from '../store/sidebarSlice';
...
import { ReactComponent as BookingList } from '../assets/images/booking_list.svg';
...
useEffect(() => {
 ...
 // Define style objects for hiding and showing the mobile menu box
  ...
  const mobileMenuIconDisplay =window.location.pathname === '/employee-home'  || !isMobile ? hidemobilemenuicon : showmobilemenuicon;
          ...
          <div className='container'>
            <div className='header-bg'>
              ...
              <div className='logo-box'>
                <a href='/employee-home'><img src={HomeLogo} alt="Home Logo" /></a>
              </div>
              {/* NAVIBAR */}
              <ul className='navibar desktop-menu-box'>
                ...
                <li className='menu-link-box' >
                  <Link to="/service-upload" className="menu-link">Services Upload</Link>
                </li>
                <li className='menu-link-box'>
                  <Link to="/employee-booking-list" className="menu-link">Booking List</Link>
                </li>
              </ul>

              <ul className='navibar mobile-menu-box' style={mobileMenuIconDisplay}>
                <button className='mobileMenu-open'  onClick={() => dispatch(toggleEmpSidebar())}>
                  ...
                  {isLoginPanelOpen && (
                    <ul className=' login-panel'>
                      <li className='menu-link-box'>
                        ...
                        <Link to="/employee-edit-profile" className="menu-link">Profile</Link>
                      </li>
                      <li className='menu-link-box'>
                        <LogoutIcon style={{ marginRight: '10px' }} className='menu-icon' />
                        <Link to="/employee-index" className="menu-link">Logout</Link>
                      </li>
                    </ul>
                  )}
                </li>
